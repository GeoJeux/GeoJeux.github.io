...
pays = Math.floor(Math.random() * tblPays.length);
  ...
  function lives(){
    ...
    if (vies > 0){
      ...
      popUp.id = 'gameOver';
      popUp.innerHTML = "Game Over<br>Vous avez perdu<br>Votre score est de <br><h1>" + score + "<h1><br><input type='button' value='Rejouer' onclick='location.reload();'> </a> <a href='GeoJeux.github.io
'><input type='button' value='Quitter'<a>";
