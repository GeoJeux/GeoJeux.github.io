var tblPays = [
  ...
  ["OMAN", "Mascate", "Asie", 309500, "<img src='images/Oman.png' class='image'>", "<img src='image/Drapeau/Omand.png' class='image'>"],
  ["OUGANDA", "Kampala", "Afrique", 241038, "<img src='images/Ouganda.png' class='image'>", "<img src='image/Drapeau/Ougandad.png' class='image'>"],
  ["OUZBÉKISTAN", "Tachkent", "Asie", 447400, "<img src='images/Ouzbekistan.png' class='image'>", "<img src='image/Drapeau/Ouzbekistand.png' class='image'>"],
  ["PAKISTAN", "Islamabad", "Asie", 881913, "<img src='images/Pakistan.png' class='image'>", "<img src='image/Drapeau/Pakistand.png' class='image'>"],
  ["PALAOS", "Ngerulmud", "Océanie", 459, "<img src='images/Palau.png' class='image'>", "<img src='image/Drapeau/Palaud.png' class='image'>"],
  ["PANAMA", "Panama", "Nord", 75417, "<img src='images/Panama.png' class='image'>", "<img src='image/Drapeau/Panama.png' class='image'>"],
  ...
  ["PARAGUAY", "Asunción", "Sud", 406752, "<img src='images/Paraguay.png' class='image'>", "<img src='image/Drapeau/Paraguayd.png' class='image'>"],
  ["PÉROU", "Lima", "Sud", 1285216, "<img src='images/Perou.png' class='image'>", "<img src='image/Drapeau/Peroud.png' class='image'>"],
  ["PORTO RICO", "San Juan", "Nord", 8872, "<img src='images/Puerto Rico.png' class='image'>", "<img src='image/Drapeau/Puerto Ricod.png' class='image'>"],
  ["QATAR", "Doha", "Asie", 11571, "<img src='images/Qatar.png' class='image'>", "<img src='image/Drapeau/Qatard.png' class='image'>"],
  ["ROUMANIE", "Bucarest", "Europe", 238391, "<img src='images/Roumanie.png' class='image'>", "<img src='image/Drapeau/Roumanied.png' class='image'>"],
  ["ROYAUME-UNI", "Londres", "Europe", 243610, "<img src='images/UK.png' class='image'>", "<img src='image/Drapeau/UK.png' class='image'>"],
  ["RUSSIE", "Moscou", "Europe", 17098242, "<img src='images/Russie.png' class='image'>", "<img src='image/Drapeau/Russied.png' class='image'>"],
  ["RWAANDA", "Kigali", "Afrique", 26338, "<img src='images/Rwanda.png' class='image'>", "<img src='image/Drapeau/Rwadad.png' class='image'>"],
  ["SAINT-KITTS-ET-NEVIS", "Basseterre", "Nord", 261, "<img src='images/Kitts et Nieve.png' class='image'>", "<img src='image/Drapeau/Saint Kitts et Nevis.png' class='image'>"],
  ["SAINT-LUCIE", "Castries", "Nord", 616, "<img src='images/Saint Lucie.png' class='image'>", "<img src='image/Drapeau/Saint Lucied.png' class='image'>"],
  ["SAINT-MARIN", "Saint-Marin", "Europe", 61, "<img src='images/Saint Marin.png' class='image'>", "<img src='image/Drapeau/SaintMarind.png' class='image'>"],
  ["SAINT-VINCENT-ET-LES GRENADINES", "Kingstown", "Nord", 389, "<img src='images/Saint Vincent.png' class='image'>", "<img src='image/Drapeau/Saint Vincented.png' class='image'>"],
  ["SALOMON", "Honiara", "Océanie", 28400, "<img src='images/Solomon Islands.png' class='image'>", "<img src='image/Drapeau/Solomon Islands.png' class='image'>"],
  ["SAMOA", "Apia", "Océanie", 294, "<img src='images/Samoa.png' class='image'>", "<img src='image/Drapeau/Samoad.png' class='image'>"],
  ["SÃO TOMÉ-ET-PRÍNCIPE", "São Tomé", "Afrique", 964, "<img src='images/Sao Tome et Principe.png' class='image'>", "<img src='image/Drapeau/Sao Tome et Principe.png' class='image'>"],
  ["SÉNÉGAL", "Dakar", "Afrique", 196722, "<img class='image' src='images/Senegal.png'>", "<img class='image' src='image/Drapeau/Senegald.png'>"],
  ["SERBIE", "Belgrade", "Europe", 88361, "<img class='image' src='images/Serbie.png'>", "<img class='image' src='image/Drapeau/Serbied.png'>"],
  ["SEYCHELLES", "Victoria", "Afrique", 455, "<img class='image' src='images/Seychelles.png'>", "<img class='image' src='image/Drapeau/Seychellesd.png'>"],
  ["SIERRA LEONE", "Freetown", "Afrique", 71740, "<img class='image' src='images/Sierra Leone.png'>", "<img class='image' src='image/Drapeau/Sierra Leoned.png'>"],
  ["SINGAPOUR", "Singapour", "Asie", 716, "<img class='image' src='images/Singapore.png'>", "<img class='image' src='image/Drapeau/Singapored.png' class='image'>"],
  ["SOMALIE", "Mogadiscio", "Afrique", 637657, "<img class='image' src='images/Somalie.png'>", "<img class='image' src='image/Drapeau/Somalied.png' class='image'>"],
  ["SRI LANKA", "Colombo", "Asie", 65610, "<img class='image' src='images/Sri Lanka.png'>", "<img class='image' src='image/Drapeau/SriLankad.png' class='image'>"],
  ["SUDAN", "Khartoum", "Afrique", 1861484, "<img class='image' src='images/Sudan.png'>", "<img class='image' src='image/Drapeau/Sudand.png' class='image'>"],
  ["SURINAME", "Paramaribo", "Sud", 163820, "<img class='image' src='images/Suriname.png'>", "<img class='image' src='image/Drapeau/Surinamed.png' class='image'>"],
  ["SUÈDE", "Stockholm", "Europe", 450295, "<img class='image' src='images/Suede.png'>", "<img class='image' src='image/Drapeau/Sueded.png' class='image'>"],
  ["SUD-SUDAN", "Djouba", "Afrique", 619745, "<img class='image' src='images/Sudan Sud.png'>", "<img class='image' src='image/Drapeau/SudSudand.png' class='image'>"],
  ["SUISSE", "Berne", "Europe", 41284, "<img class='image' src='images/Suisse.png'>", "<img class='image' src='image/Drapeau/Suissed.png' class='image'>"],
  ["SYRIE", "Damas", "Asie", 185180, "<img class='image' src='images/Syrie.png'>", "<img class='image' src='image/Drapeau/Syried.png' class='image'>"],
  ["TAIWAN", "Taipei", "Asie", 36193, "<img class='image' src='images/Taiwan.png'>", "<img class='image' src='image/Drapeau/Taiwand.png'>"],
  ["TADJIKISTAN", "Douchanbé", "Asie", 143100, "<img class='image' src='images/Tadjikistan.png'>", "<img class='image' src='image/Drapeau/Tadjikistand.png'>"],
  ["TANZANIE", "Dodoma", "Afrique", 945087, "<img class='image' src='images/Tanzanie.png'>", "<img class='image' src='image/Drapeau/Tanzanied.png'>"],
  ["TCHAD", "N'Djamena", "Afrique", 1284000, "<img class='image' src='images/Tchad.png'>", "<img class='image' src='image/Drapeau/Tchadd.png'>"],
  ["TUNISIE", "Tunis", "Afrique", 163610, "<img class='image' src='images/Tunisia.png'>", "<img class='image' src='image/Drapeau/Tunisied.png'>"],
  ["TIMOR-LESTE", "Dili", "Asie", 1342068, "<img class='image' src='images/Timor Leste.png'>", "<img class='image' src='image/Drapeau/TimorLested.png'>"],
  ["THAÏLANDE", "Bangkok", "Asie", 513120, "<img class='image' src='images/Thailande.png'>", "<img class='image' src='image/Drapeau/Thailanded.png'>"],
  ["TURKMÉNISTAN", "Achgabat", "Asie", 491210, "<img class='image' src='images/Turkmenistan.png'>", "<img class='image' src='image/Drapeau/Turkmenistand.png'>"],
  ["TURQUIE", "Ankara", "Asie", 783562, "<img class='image' src='images/Turkiye.png'>", "<img class='image' src='image/Drapeau/Turquied.png'>"],
  ["TOGO", "Lomé", "Afrique", 8278724, "<img class='image' src='images/Togo.png'>", "<img class='image' src='image/Drapeau/Togod.png'>"],
  ["TONGA", "Nuku'alofa", "Océanie", 748, "<img class='image' src='images/Tonga.png'>", "<img class='image' src='image/Drapeau/Tongad.png'>"],
  ["TRINITÉ-ET-TOBAGO", "Port-d'Espagne", "Nord", 5130, "<img class='image' src='images/Trinidad et Tobago.png'>", "<img class='image' src='image/Drapeau/Trinite-et-Tobagod.png'>"],
  ["TUVALU", "Funafuti", "Océanie", 26, "<img class='image' src='images/Tuvalu.png'>", "<img class='image' src='image/Drapeau/Tuvalud.png'>"],
  ["UKRAINE", "Kyiv", "Europe", 603550, "<img class='image' src='images/Ukraine.png'>", "<img class='image' src='image/Drapeau/Ukrained.png'>"],
  ["URUGUAY", "Montevideo", "Sud", 176215, "<img class='image' src='images/Uruguay.png'>", "<img class='image' src='image/Drapeau/Uruguayd.png'>"],
  ["VANUATU", "Port-Vila", "Océanie", 12189, "<img class='image' src='images/Vanuatu.png'>", "<img class='image' src='image/Drapeau/Vanuatud.png'>"],
  ["VENEZUELA", "Caracas", "Sud", 912050, "<img class='image' src='images/Venezuela.png'>", "<img class='image' src='image/Drapeau/Venezuelaas.png'>"],
  ["VIETNAM", "Hanoï", "Asie", 331210, "<img class='image' src='images/Vietnam.png'>", "<img class='image' src='image/Drapeau/Vietnamd.png'>"],
  ["YÉMEN", "Sanaa", "Asie", 527968, "<img class='image' src='images/Yemen.png'>", "<img class='image' src='image/Drapeau/Yemend.png'>"],
  ["ZAMBIE", "Lusaka", "Afrique", 752612, "<img class='image' src='images/Zambia.png'>", "<img class='image' src='image/Drapeau/Zambied.png'>"],
  ["ZIMBABWE", "Harare", "Afrique", 390757, "<img class='image' src='images/Zimbabwe.png'>", "<img class='image' src='image/Drapeau/Zimbabwed.png'>"]
]
